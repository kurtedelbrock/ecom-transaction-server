class RecommendationsController < ApplicationController
  ...
  def index
    ...
    url = "http://whispering-falls-1789.herokuapp.com/cases/p/q30/#{packingAnswer1}#{packing1}/q31/#{packingAnswer2}#{packing2}/q32/#{packingAnswer3}#{packing3}/q33/#{packingAnswer4}#{packing4}/q34/#{packingAnswer5}#{packing5}/q35/#{packingAnswer6}#{packing6}/q36/#{packingAnswer7}#{packing7}.json?filter=#{filter}"
